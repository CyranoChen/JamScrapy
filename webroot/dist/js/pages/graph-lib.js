var config = {
    ...
    'DICT': {
        ...
        'FIELD': {
            ...
            'Category Burst': ['networktype', 'boardarea', 'functionalarea', 'region', 'city', 'costcenter', 'gender'],
            'Force': ['networktype', 'boardarea', 'functionalarea', 'region', 'city', 'costcenter', 'gender', 'community'],
            'Circular': ['networktype', 'boardarea', 'functionalarea', 'region', 'city', 'costcenter', 'gender']
        },
        'GEO_CITY': {},
        'GEO_CITY_DATA': {}
    },
