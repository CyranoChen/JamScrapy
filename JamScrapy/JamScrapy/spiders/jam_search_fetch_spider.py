...
class JamSearchFetchSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        results = engine.execute(f"select * from spider_jam_search where body = '[]'")
        ...
        for item in results:
            ...
            yield SplashRequest(item.url, callback=self.parse, endpoint='execute', cache_args=['lua_source'],
